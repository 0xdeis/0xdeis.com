...
You need to select a unique identifier for your project, called a module path, so that people can locate and import code from it.
If you have a domain, a commen convention is to use a URL that you have control over. I personally use `github.com/AlexanderHOtt/<project name>`, but if you have a domain you want to use, it could be `<project name>.example.com`.
