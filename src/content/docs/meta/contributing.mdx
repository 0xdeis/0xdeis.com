...
If all you want to do is make a quick edit to a page, there is an "edit page"
button at the bottom of every page that brings you to github. Make your edits,
and open a PR.

## Development

This website/documentation page was built with
[Starlight](https://starlight.astro.build/). You write markdown or mdx (markdown
extended) and it turns into html.
