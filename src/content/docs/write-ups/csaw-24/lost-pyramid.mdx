...
<FileTree>
  - static/ - *.webp - templates/ - anubis_chamber.html - hallway.html -
  kings_lair.html - osiris_hall.html - pyramid.html - scarab_room.html -
  Dockerfile - app.py - private_key.pem - public_key.pub - requirements.txt
</FileTree>
